...
LastEditTime: 2023-11-04 17:36:43
"""
...
class PlotterLauncher():
    ...
    def error_time_bar():
        ...
        Plotter.plot_error_time_bar(x, x_data, APMISRR_mean[0], APMISRR_diff[0], TolerMIS_mean[0], TolerMIS_diff[0], SIS_mean[0], SIS_diff[0], f"./output/error_plots/time_1_error_place_{time_str}")
        Plotter.plot_error_time_bar(x, x_data, APMISRR_mean[1], APMISRR_diff[1], TolerMIS_mean[1], TolerMIS_diff[1], SIS_mean[1], SIS_diff[1], f"./output/error_plots/time_2_error_place_{time_str}")
        Plotter.plot_error_time_bar(x, x_data, APMISRR_mean[2], APMISRR_diff[2], TolerMIS_mean[2], TolerMIS_diff[2], SIS_mean[2], SIS_diff[2], f"./output/error_plots/time_3_error_place_{time_str}")
        Plotter.plot_error_time_bar(x, x_data, APMISRR_mean[3], APMISRR_diff[3], TolerMIS_mean[3], TolerMIS_diff[3], SIS_mean[3], SIS_diff[3], f"./output/error_plots/time_4_error_place_{time_str}")
