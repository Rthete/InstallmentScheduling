 ...
 * @LastEditTime: 2023-11-04 14:58:20
 */
#include "exp_3.h"
...
namespace exp_3
{
    ...
    void error_SIS_30()
    {
        ...
        for (int i = 1; i <= 4; ++i)
        {
            ...
            std::ofstream numFile("../output/exp_3/error_SIS_30_" + std::to_string(i) + ".csv");
            /* 任务量w */
    ...
    void error_cmp_3_models_ur() {
        ...
        for (int i = 1; i <= 4; ++i)
        {
            ...
            readTXTFile("../data/exp3-error-place/error-place-30-" + std::to_string(i) + ".txt", error_places);
            readTXTFile("../data/exp3-error-place/error-installment-2.txt", error_installment);
            std::ofstream numFile("../output/exp_3_all_exps/error_ur_30_" + std::to_string(i) + ".csv");
            /* 任务量w */
            int index_w = 0;
